...
*/
{
  ...
  "kaio",
  "demon", "majin", "saiyan-n", "saiyan-h", "saiyan-hb", "saiyan-s", "human-n",
  "human-hb", "namek-hb", "numan-h", "super-namek", "halfbreed-hb", "halfbreed-s",
  "halfbreed-n", "halfbreed-h", "namek-h", "namek-s", "human-s", "super-android",
  "genie", "android-h", "android-e", "android-fm", "saibaman", "symbiote", "tuffle",
  "yardratian", "ant", "ape", "baboon", "bat", "bear", "bee", "beetle", "boar",
