...
void do_shakkahou( CHAR_DATA * ch, char *argument )
{
  ...
  if( can_use_skill( ch, number_percent(  ), gsn_shakkahou ) )
  {
    ...
    act( AT_RED, "of the demon!  Skill 21!  Errupt!  ' You toss your hand out and the aura", ch, NULL, victim, TO_CHAR );
    ...
    act( AT_RED, "to spin around my body.  Enhance my power; help me dispose of my foe!  Art", ch, NULL, victim,
         TO_NOTVICT );
    act( AT_RED, "of the demon!  Skill 21!  Errupt!' $n toss $s hand out and the aura", ch, NULL, victim, TO_NOTVICT );
    ...
    act( AT_RED, "of the demon!  Skill 21!  Errupt!' $n toss $s hand out and the aura", ch, NULL, victim, TO_VICT );
    ...
    global_retcode = damage( ch, victim, ( get_attmod( ch, victim ) * number_range( 8, 12 ) ), gsn_shakkahou );
  }
  else
  {
