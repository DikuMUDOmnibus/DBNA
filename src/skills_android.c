...
void do_ehb( CHAR_DATA * ch, char *argument )
{
  ...
  {
    dam = get_attmod( ch, victim ) * number_range( 72, 90 );
    if( ch->charge > 0 )
      dam = chargeDamMult( ch, dam );
...
//  if ( !IS_NPC(ch) && ch->pcdata->sd_charge < chargesUsed )
  if( !IS_NPC( ch ) && ch->pcdata->sd_charge < 50 )
  {
...
void do_ki_burst( CHAR_DATA * ch, char *argument )
{
  ...
  {
    dam = get_attmod( ch, victim ) * number_range( 56, 64 );
    if( ch->charge > 0 )
      dam = chargeDamMult( ch, dam );
    ...
    act( AT_PURPLE, "prepared, you course a vast amount of energy through your arms while extending", ch, NULL, victim, TO_CHAR );
    act( AT_PURPLE, "them outwards. Pumping a final burst of ki into the attack, a hulking sphere", ch, NULL, victim, TO_CHAR );
    act( AT_PURPLE, "forms into existence and radiates a boisterous crack as energy lashes into the", ch, NULL, victim, TO_CHAR );
    act( AT_PURPLE, "air. Without caution, the sphere progresses toward its destination at a", ch, NULL, victim, TO_CHAR );
    act( AT_PURPLE, "blinding speed and erupts as it confronts $N with a devastating blow. &W[$t]", ch, num_punct( dam ), victim, TO_CHAR );
    ...
    act( AT_PURPLE, "prepared, $e courses a vast amount of energy through $s arms while extending", ch, NULL, victim, TO_VICT );
    act( AT_PURPLE, "them outwards. Pumping a final burst of ki into the attack, a hulking sphere", ch, NULL, victim, TO_VICT );
    act( AT_PURPLE, "forms into existence and radiates a boisterous crack as energy lashes into the", ch, NULL, victim, TO_VICT );
    act( AT_PURPLE, "air. Without caution, the sphere progresses toward its destination at a", ch, NULL, victim, TO_VICT );
    act( AT_PURPLE, "blinding speed and erupts as it confronts you with a devastating blow. &W[$t]", ch, num_punct( dam ), victim, TO_VICT);
    ...
    act( AT_PURPLE, "prepared, $e courses a vast amount of energy through $s arms while extending", ch, NULL, victim, TO_NOTVICT );
    act( AT_PURPLE, "them outwards. Pumping a final burst of ki into the attack, a hulking sphere", ch, NULL, victim, TO_NOTVICT );
    act( AT_PURPLE, "forms into existence and radiates a boisterous crack as energy lashes into the", ch, NULL, victim, TO_NOTVICT );
    act( AT_PURPLE, "air. Without caution, the sphere progresses toward its destination at a", ch, NULL, victim, TO_NOTVICT );
    act( AT_PURPLE, "blinding speed and erupts as it confronts $N with a devastating blow. &W[$t]", ch, num_punct( dam ), victim, TO_NOTVICT );
  ...
  else
  {
    ...
    act( AT_PURPLE, "them outwards. Pumping a final burst of ki into the attack, a hulking sphere", ch, NULL, victim, TO_CHAR );
    act( AT_PURPLE, "forms into existence and radiates a boisterous crack as energy lashes into the", ch, NULL, victim, TO_CHAR );
    act( AT_PURPLE, "air. Without caution, the sphere progresses toward its destination but misses", ch, NULL, victim, TO_CHAR );
    ...
    act( AT_PURPLE, "them outwards. Pumping a final burst of ki into the attack, a hulking sphere", ch, NULL, victim, TO_VICT );
    act( AT_PURPLE, "forms into existence and radiates a boisterous crack as energy lashes into the", ch, NULL, victim, TO_VICT );
    act( AT_PURPLE, "air. Without caution, the sphere progresses toward its destination but misses", ch, NULL, victim, TO_VICT );
    ...
    act( AT_PURPLE, "them outwards. Pumping a final burst of ki into the attack, a hulking sphere", ch, NULL, victim, TO_NOTVICT );
    act( AT_PURPLE, "forms into existence and radiates a boisterous crack as energy lashes into the", ch, NULL, victim, TO_NOTVICT );
    act( AT_PURPLE, "air. Without caution, the sphere progresses toward its destination but misses", ch, NULL, victim, TO_NOTVICT );
...
*/
  if( ch->exp < ch->pl )
  {
    send_to_char( "You must be at base.\n\r", ch );
    return;
  }
...
void do_t1( CHAR_DATA * ch, char *argument )
{
  ...
  {
    removeDroidTrans( ch );
    act( AT_RED, "As the chip’s programming surges through your core, a blast of red energy flows", ch, NULL, NULL, TO_CHAR ); 
