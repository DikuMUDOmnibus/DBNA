...
void do_kick( CHAR_DATA * ch, char *argument )
{
  ...
  if( can_use_skill( ch, number_percent(  ), gsn_kick ) )
  {
    ...
    if( is_saiyan_s( ch ) && ch->pcdata->learned[gsn_ssj4] >= 100
        && ch->pcdata->learned[gsn_super_oozaru] < 10 && ch->style == STYLE_BERSERK && ch->exp >= 25000000000000 )
    {
...
void do_energy_ball( CHAR_DATA * ch, char *argument )
{
  ...
  if( can_use_skill( ch, number_percent(  ), gsn_energy_ball ) )
  {
    ...
    act( AT_BLUE, "you release the sphere in $N's direction and injure $M slightly. &W[$t]", ch, num_punct( dam ), victim, TO_CHAR );
    ...
    act( AT_BLUE, "look $e releases the sphere in your direction and injures you slightly. &W[$t]", ch, num_punct( dam ), victim, TO_VICT );

    act( AT_BLUE, "An orb of energy flickers softly as it emerges from $n's unfolded", ch, NULL, victim, TO_NOTVICT );
    act( AT_BLUE, "hand. Spreading $s fingers widely changes the sputter into a more dominant", ch, NULL, victim, TO_NOTVICT );
    act( AT_BLUE, "ball with a majority of ki focused on the core of the attack. With a solemn", ch, NULL, victim, TO_NOTVICT );
...
*/
  ...
  if( can_use_skill( ch, number_percent(  ), gsn_super_kamehameha ) )
  {
    ...
    if( ch->charge > 0 )
      dam = chargeDamMult( ch, dam );
    act( AT_LBLUE, "You clasp your hands together and close your eyes to focus on the spiritual", ch, NULL, victim, TO_CHAR );
    act( AT_LBLUE, "summoning about to arise. Eyes flashing open, your power level flares up as", ch, NULL, victim, TO_CHAR );
    act( AT_LBLUE, "your hands cup a small ball of energy forming from the surrounding atmosphere.", ch, NULL, victim, TO_CHAR );
    act( AT_LBLUE, "Screaming out with animosity you call out &B'KA-ME-HAA-MEE'&C and the image of", ch, NULL, victim, TO_CHAR );
    act( AT_LBLUE, "another warrior appears behind with a second ball of energy embraced in $s", ch, NULL, victim, TO_CHAR );
    act( AT_LBLUE, "hands. &B'HAAAAAAA!!'&C The two consecutive balls are released and blend into a", ch, NULL, victim, TO_CHAR );
    ...
    act( AT_LBLUE, "summoning about to arise. Eyes flashing open, $n's power level flares up as", ch, NULL, victim, TO_VICT );
    act( AT_LBLUE, "$s hands cup a small ball of energy forming from the surrounding atmosphere.", ch, NULL, victim, TO_VICT );
    act( AT_LBLUE, "Screaming out with animosity $e calls out &B'KA-ME-HAA-MEE'&C and the image of", ch, NULL, victim, TO_VICT );
    act( AT_LBLUE, "another warrior appears behind with a second ball of energy embraced in $s", ch, NULL, victim, TO_VICT );
    act( AT_LBLUE, "hands. &B'HAAAAAAA!!'&C The two consecutive balls are released and blend into a", ch, NULL, victim, TO_VICT );
    act( AT_LBLUE, "more destructive assault as the attack strikes you. &W[$t]", ch, num_punct ( dam ), victim, TO_VICT );
    
    act( AT_LBLUE, "$n clasps $s hands together and closes $s eyes to focus on the spiritual", ch, NULL, victim, TO_NOTVICT );
    act( AT_LBLUE, "summoning about to arise. Eyes flashing open, $n's power level flares up as", ch, NULL, victim, TO_NOTVICT );
    act( AT_LBLUE, "$s hands cup a small ball of energy forming from the surrounding atmosphere.", ch, NULL, victim, TO_NOTVICT );
    act( AT_LBLUE, "Screaming out with animosity $e calls out &B'KA-ME-HAA-MEE'&C and the image of", ch, NULL, victim, TO_NOTVICT );
    act( AT_LBLUE, "another warrior appears behind with a second ball of energy embraced in $s", ch, NULL, victim, TO_NOTVICT );
    act( AT_LBLUE, "hands. &B'HAAAAAAA!!'&C The two consecutive balls are released and blend into a", ch, NULL, victim, TO_NOTVICT );
  ...
  else
  {
    ...
    act( AT_LBLUE, "another warrior appears behind with a second ball of energy embraced in $s", ch, NULL, victim, TO_CHAR );
    act( AT_LBLUE, "hands. &B'HAAAAAAA!!'&C The two consecutive balls are released and blend into a", ch, NULL, victim, TO_CHAR );
    act( AT_LBLUE, "more destructive assault but unexpectedly take a turn and miss the intended ", ch, NULL, victim, TO_CHAR );
    ...
    act( AT_LBLUE, "another warrior appears behind with a second ball of energy embraced in $s", ch, NULL, victim, TO_NOTVICT );
    act( AT_LBLUE, "hands. &B'HAAAAAAA!!'&C The two consecutive balls are released and blend into a", ch, NULL, victim, TO_NOTVICT );
    act( AT_LBLUE, "more destructive assault but unexpectedly take a turn and miss the intended", ch, NULL, victim, TO_NOTVICT );
...
void do_super_dragonfist( CHAR_DATA * ch, char *argument )
{
  ...
  if( !xIS_SET( ch->affected_by, AFF_SSJ3 ) )
  {
    if( !xIS_SET( ch->affected_by, AFF_SSJ4 ) )
    {
      send_to_char( "You must be in ssj3 or ssj4 to do this attack.\n\r", ch );
      return;
    }
  }
    ...
    switch ( number_range( 1, 100 ) )
    {
      ...
      case 95:
        if( IS_NPC( victim ) || ( !IS_NPC( victim ) && ( !xIS_SET( ch->act, PLR_SPAR ) || !xIS_SET( ch->act, PLR_SPAR ) ) ) )
        {
          ...
          if( victim->pl / ch->pl >= 2 )
          {
            act( AT_DGREY, "With impeccable swiftness you hurtle toward $N with an outstretched arm", ch, NULL, victim, TO_CHAR );
            act( AT_DGREY, "pinpointing the location of impact. Calling upon the eternal dragon for strength", ch, NULL, victim, TO_CHAR );
            act( AT_DGREY, "you yell, &YDRAGON FIST!. &zAbruptly your once prolonged arm has now altered", ch, NULL, victim, TO_CHAR );
            act( AT_DGREY, "into an impressive golden dragon with mouth gaping extensively. The initial blow", ch, NULL, victim, TO_CHAR );
            ...
            act( AT_DGREY, "With impeccable swiftness $n hurtles toward you with an outstretched arm", ch, NULL, victim, TO_VICT );
            act( AT_DGREY, "pinpointing the location of impact. Calling upon the eternal dragon for strength", ch, NULL, victim, TO_VICT );
            act( AT_DGREY, "$e yells, &YDRAGON FIST!. &zAbruptly $s once prolonged arm has now", ch, NULL, victim, TO_VICT );
            act( AT_DGREY, "altered into an impressive golden dragon with mouth gaping extensively. The", ch, NULL, victim, TO_VICT );
            act( AT_DGREY, "initial blow devastates you only to be pursued by a torrential upsurge of energy", ch, NULL, victim, TO_VICT );
            ...
            act( AT_DGREY, "arm pinpointing the location of impact. Calling upon the eternal dragon for", ch, NULL, victim, TO_NOTVICT );
            act( AT_DGREY, "strength $e yells, &YDRAGON FIST!. &zAbruptly $n.s once prolonged", ch, NULL, victim, TO_NOTVICT );
            act( AT_DGREY, "arm has now altered into an impressive golden dragon with mouth gaping", ch, NULL, victim, TO_NOTVICT );
            act( AT_DGREY, "extensively. The initial blow devastates $N only to be pursued by a torrential", ch, NULL, victim, TO_NOTVICT);
      ...
      default:
        dam = get_attmod( ch, victim ) * number_range( 78, 90 );
        if( ch->charge > 0 )
          dam = chargeDamMult( ch, dam );
            act( AT_DGREY, "With impeccable swiftness you hurtle toward $N with an outstretched arm", ch, NULL, victim, TO_CHAR );
            act( AT_DGREY, "pinpointing the location of impact. Calling upon the eternal dragon for strength", ch, NULL, victim, TO_CHAR );
            ...
            act( AT_DGREY, "arm has now altered into an impressive golden dragon with mouth gaping", ch, NULL, victim, TO_NOTVICT );
            act( AT_DGREY, "extensively. The initial blow devastates $N only to be pursued by a torrential", ch, NULL, victim, TO_NOTVICT );
            act( AT_DGREY, "upsurge of energy created from the outburst of the assault. &W[$t]", ch, num_punct( dam ), victim, TO_NOTVICT );
...
void do_kakusandan( CHAR_DATA * ch, char *argument )
{
  ...
  if( can_use_skill( ch, number_percent(  ), gsn_kakusandan ) )
  {
     ...
     * dam = get_attmod(ch, victim) * number_range( 34, 40 );
     */
    dam = get_attmod( ch, victim ) * number_range( 40, 53 );
    if( ch->charge > 0 )
      dam = chargeDamMult( ch, dam );
/*	act( AT_SKILL, "You form your fingers into a triangle, spotting $N in your sights before pummeling $M with a powerfull beam of inner energy. &W[$t]", ch, num_punct(dam), victim, TO_CHAR );
 *	act( AT_SKILL, "$n forms $s fingers into a triangle, spotting you in $s sights before pummeling you with a powerfull beam of inner energy. &W[$t]", ch, num_punct(dam), victim, TO_VICT );
...
void do_sanctuary( CHAR_DATA * ch, char *argument )
{
  ...
  if( ( is_kaio( ch ) && ch->rank < 1 ) || ( is_demon( ch ) && ch->rank < 3 ) || ( !is_kaio( ch ) && !is_demon( ch ) ) )
  {
    ch_printf( ch, "Huh?\n\r" );
    return;
  }
...
void do_dodon_ray( CHAR_DATA * ch, char *argument )
{
  ...
  if( can_use_skill( ch, number_percent(  ), gsn_dodon_ray ) )
  {
    ...
    act( AT_BLUE, "and begins to rotate rapidly.  After coiling for a moment, the vortex compresses", ch, NULL, victim, TO_CHAR );
    act( AT_BLUE, "your finger slightly before being released toward the intended target.  A blue", ch, NULL, victim, TO_CHAR );
    ...
    act( AT_BLUE, "compresses $s finger slightly before being released toward the intended target.", ch, NULL, victim, TO_VICT );
    ...
    act( AT_BLUE, "Extending a finger towards $N, a convection of energy bursts forward from", ch, NULL, victim, TO_NOTVICT );
    act( AT_BLUE, "$n and begins to rotate rapidly.  After coiling for a moment, the vortex", ch, NULL, victim, TO_NOTVICT );
    act( AT_BLUE, "compresses $s finger slightly before being released toward the intended target.", ch, NULL, victim, TO_NOTVICT );
...
void do_thunder_flash(CHAR_DATA *ch, char *argument )
{
    ...
    if ( !IS_NPC(ch)
    &&   ch->exp < skill_table[gsn_thunder_flash]->skill_level[ch->class] )
    {
    send_to_char( "You can't do that.\n\r", ch );
    return;
    }
...
//    act( AT_RED, "You extend both arms to either side of yourself, and exclaim 'THUNDER' then bring your arms infront of you, fists together, exclaiming 'FLASH' then sends a massive column of fire out of your fists toward $N!!!'", ch, NULL, victim, TO_CHAR );
    act( AT_RED, "You extend both arms to either side of yourself, and exclaim 'THUNDER' then bring your arms infront of you, fists together, exclaiming 'FLASH' then sends a massive column of fire out of your fists toward $N!!!! &W[$t]", ch, num_punct(dam), victim, TO_CHAR );
//    act( AT_RED, "$n puts $s arms back and cups $s hands. 'THUNDER FLASH!!!!'", ch, NULL, victim, TO_VICT );
    act( AT_RED, "$n extend both arms to either side of themself, and exclaim 'THUNDER' then bring their arms infront of them, fists together, exclaiming 'FLASH' then sends a massive column of fire out of $s fists toward you!!!! &W[$t]", ch, num_punct(dam), victim, TO_VICT );
//    act( AT_RED, "$n extend both arms to either side of themself, and exclaim 'THUNDER' then bring their arms infront of them, fists together, exclaiming 'FLASH' then sends a massive column of fire out of $s fists toward $N!!!!'", ch, NULL, victim, TO_NOTVICT );
    act( AT_RED, "$n extend both arms to either side of themself, and exclaim 'THUNDER' then bring their arms infront of them, fists together, exclaiming 'FLASH' then sends a massive column of fire out of $s fists toward $N!!!! &W[$t]", ch, num_punct(dam), victim, TO_NOTVICT );
...
void do_evilboost( CHAR_DATA * ch, char *argument )
{
  ...
  if( arg < 3 || arg > 6 )
  {
    ch_printf( ch, "Syntax: 'evil boost' [3-6]\n\r" );
    return;
  }
...
void do_evilsurge( CHAR_DATA * ch, char *argument )
{
  ...
  if( arg < 8 || arg > 14 )
  {
    ch_printf( ch, "Syntax: 'evil surge' [8-14]\n\r" );
    return;
  }
...
void do_eviloverload( CHAR_DATA * ch, char *argument )
{
  ...
  if( arg < 18 || arg > 24 )
  {
    ch_printf( ch, "Syntax: 'evil overload' [18-24]\n\r" );
    return;
  }
...
void do_demonweapon( CHAR_DATA * ch, char *argument )
{
  ...
  if( can_use_skill( ch, number_percent(  ), gsn_demonweapon ) )
  {
    ...
    if( newmod > 1 )
    {
      o->value[1] = URANGE( 2, ( newmod - 1 ), 5 );
      o->value[2] = URANGE( 8, ( ( newmod - 1 ) * 5 ), 25 );
    }
...
bool wearing_mystic_sword( CHAR_DATA * ch )
{
...
bool wearing_mystic_tunic( CHAR_DATA * ch )
{
  OBJ_DATA *obj, *obj_next;
  for( obj = ch->first_carrying; obj != NULL; obj = obj_next )
  {
...
bool wearing_mystic_cap( CHAR_DATA * ch )
{
  OBJ_DATA *obj, *obj_next;
  for( obj = ch->first_carrying; obj != NULL; obj = obj_next )
  {
...
{
  if( is_demon( ch ) || is_genie( ch ) || is_android( ch ) || is_superandroid( ch ) || is_icer( ch ) || is_bio( ch ) )
  {
  ...
  if( !IS_NPC( ch ) )
  {
    if( !IS_SET( ch->pcdata->flags, PCFLAG_KNOWSMYSTIC ) && !is_kaio( ch ) )
    {
      ch_printf( ch, "You don't know how to use this technique.\n\r" );
      return;
    }
    if( ch->rank == 3 && is_saiyan( ch ) )
    {
      ch_printf( ch, "You already got Lssj.\n\r" );
      return;
    }
  }
...
/* Boosted PL_mult from 20 to 25. -Karn 01.19.05 */
/* Added stuff to lower other races transformation mult. -Karn 06.04.05 */

  if( is_kaio( ch ) && !wearing_mystic_tunic( ch ) && !wearing_mystic_sword( ch ) )
    pl_mult = 25;
  if( !is_kaio( ch ) && !wearing_mystic_tunic( ch ) && !wearing_mystic_sword( ch ) )
    pl_mult = 22;
  if( is_kaio( ch ) && wearing_mystic_tunic( ch ) && !wearing_mystic_sword( ch ) )
   ...
   */
/* Normal 
     Code: !wearing_mystic_tunic(ch) && !wearing_mystic_sword(ch)*/

  if( ( arg < 2 && is_kaio( ch ) && !wearing_mystic_tunic( ch ) && !wearing_mystic_sword( ch ) )
      || ( arg > 25 && is_kaio( ch ) && !wearing_mystic_tunic( ch ) && !wearing_mystic_sword( ch ) ) )
  {
    send_to_char( "Syntax: Mystic [2-25]\n\r", ch );
    return;
  }
  if( ( arg < 2 && !is_kaio( ch ) && !wearing_mystic_tunic( ch ) && !wearing_mystic_sword( ch ) )
      || ( arg > 22 && !is_kaio( ch ) && !wearing_mystic_tunic( ch ) && !wearing_mystic_sword( ch ) ) )
  {
    send_to_char( "Syntax: Mystic [2-22]\n\r", ch );
    return;
  }
...
/* Tunic Only 
  ...
  if( ( arg < 2 && is_kaio( ch ) && wearing_mystic_tunic( ch ) && !wearing_mystic_sword( ch ) )
      || ( arg > 25.5 && is_kaio( ch ) && wearing_mystic_tunic( ch ) && !wearing_mystic_sword( ch ) ) )
  {
    send_to_char( "Syntax: Mystic [2-25.5]\n\r", ch );
    return;
  }
  if( ( arg < 2 && !is_kaio( ch ) && wearing_mystic_tunic( ch ) && !wearing_mystic_sword( ch ) )
      || ( arg > 23 && !is_kaio( ch ) && wearing_mystic_tunic( ch ) && !wearing_mystic_sword( ch ) ) )
  {
    send_to_char( "Syntax: Mystic [2-23]\n\r", ch );
    return;
  }
...
/* Sword Only 
  ...
  if( ( arg < 2 && is_kaio( ch ) && !wearing_mystic_tunic( ch ) && wearing_mystic_sword( ch ) )
      || ( arg > 26 && is_kaio( ch ) && !wearing_mystic_tunic( ch ) && wearing_mystic_sword( ch ) ) )
  {
    send_to_char( "Syntax: Mystic [2-26]\n\r", ch );
    return;
  }
  if( ( arg < 2 && !is_kaio( ch ) && !wearing_mystic_tunic( ch ) && wearing_mystic_sword( ch ) )
      || ( arg > 23 && !is_kaio( ch ) && !wearing_mystic_tunic( ch ) && wearing_mystic_sword( ch ) ) )
  ...
  if( ( arg < 2 && is_kaio( ch ) && wearing_mystic_tunic( ch ) && wearing_mystic_sword( ch ) )
      || ( arg > 26.5 && is_kaio( ch ) && wearing_mystic_tunic( ch ) && wearing_mystic_sword( ch ) ) )
  {
    send_to_char( "Syntax: Mystic [2-26.5]\n\r", ch );
    return;
  }
  if( ( arg < 2 && !is_kaio( ch ) && wearing_mystic_tunic( ch ) && wearing_mystic_sword( ch ) )
      || ( arg > 24 && !is_kaio( ch ) && wearing_mystic_tunic( ch ) && wearing_mystic_sword( ch ) ) )
  {
    send_to_char( "Syntax: Mystic [2-24]\n\r", ch );
    return;
  }
/* End of Error Syntax */
...
void do_lssj( CHAR_DATA * ch, char *argument )
{
  ...
  {
    act( AT_YELLOW,
         "Screaming out in rage, the wrath of the legendary super saiyan takes hold of your body and merges all your muscle fibers to a more efficient state.",
         ch, NULL, NULL, TO_CHAR );
    act( AT_YELLOW,
         "flood of energy combines the molecular cells that course throughout your veins as your eyes are flushed to a bleached shade.",
         ch, NULL, NULL, TO_CHAR );
    act( AT_YELLOW,
         "As your hair flares up with the perfected form, you become strenuously influenced by the pride that accompanies the saiyan race.",
         ch, NULL, NULL, TO_CHAR );

    act( AT_YELLOW,
         "Screaming out in rage, the wrath of the legendary super saiyan takes hold of $n's body and merges all $s muscle fibers to a more efficient state.",
         ch, NULL, NULL, TO_NOTVICT );
    act( AT_YELLOW,
         "flood of energy combines the molecular cells that course throughout $s veins as $s eyes are flushed to a bleached shade.",
         ch, NULL, NULL, TO_NOTVICT );
    act( AT_YELLOW,
         "As $n's hair flares up with the perfected form, $n become strenuously influenced by the pride that accompanies the saiyan race.",
         ch, NULL, NULL, TO_NOTVICT );
  ...
  {
    act( AT_YELLOW,
         "Your body shifts slightly but returns to normal as you unable to call upon the power of the Legendary Super Saiyan.",
         ch, NULL, NULL, TO_CHAR );
    act( AT_YELLOW,
         "$n body shifts slightly but returns to normal as $n unable to call upon the power of the Legendary Super Saiyan.",
         ch, NULL, NULL, TO_NOTVICT );
...
void do_bbk( CHAR_DATA * ch, char *argument )
{
  ...
  {
    dam = get_attmod( ch, victim ) * number_range( 80, 95 );
    if( ch->charge > 0 )
      dam = chargeDamMult( ch, dam );
    ...
    act (AT_BLUE, "blinding white radiance. A vortex of gusting winds and rippling energy bands", ch, NULL, victim, TO_CHAR );
    ...
    act (AT_BLUE, "flattened palm into a vertical stance while staring indefinitely into your eyes.", ch, NULL, victim, TO_VICT );
    ...
    act (AT_BLUE, "tone $e calls out in a dual voice, &C'Big Bang Kamehameha'. &BAn immense sphere", ch, NULL, victim, TO_VICT );
    act (AT_BLUE, "emerges between you and your opponent while shrouding the area in a blinding", ch, NULL, victim, TO_VICT );
    act (AT_BLUE, "white radiance. A vortex of gusting winds and rippling energy bands disperse", ch, NULL, victim, TO_VICT );
    ...
    act (AT_BLUE, "anger in $s tone $e calls out in a dual voice, &C'Big Bang Kamehameha'. &BAn", ch, NULL, victim, TO_NOTVICT );
    act (AT_BLUE, "immense sphere emerges between $n and $s opponent while shrouding", ch, NULL, victim, TO_NOTVICT );
    act (AT_BLUE, "the area in a blinding white radiance. A vortex of gusting winds and rippling", ch, NULL, victim, TO_NOTVICT );
    act (AT_BLUE, "energy bands disperse from the core of the attack whilst destroying the", ch, NULL, victim, TO_NOTVICT );
    act (AT_BLUE, "surrounding environment with each fatal blow. Without a moments notice the orb", ch, NULL, victim, TO_NOTVICT );
...
void do_majin( CHAR_DATA * ch, char *argument )
{
  ...
  if( !ch->canmajin )
  {
    ch_printf( ch, "You dont know how to tape into your darkside...\n\r" );
    return;
  }
  ...
  if( xIS_SET( ch->affected_by, AFF_OOZARU ) || xIS_SET( ch->affected_by, AFF_GOLDEN_OOZARU )
      || xIS_SET( ch->affected_by, AFF_SUPER_OOZARU ) )
  {
    send_to_char( "You can't do this is Oozaru.", ch );
    return;
  }
  ...
  if( ch->mana < skill_table[gsn_majin]->min_mana )
  {
    send_to_char( "You don't have enough energy.\n\r", ch );
    return;
  }
  ...
  ch->mana -= skill_table[gsn_majin]->min_mana;
  return;
}
...
void do_teachmajin( CHAR_DATA * ch, char *argument )
{
  ...
  {
    if( IS_NPC( ch ) )
      act( AT_LBLUE, "Babadi says 'You already know how to tape into the dark side'", ch, NULL, vch, TO_VICT );
    else
      ch_printf( ch, "they already knows how to tape in to the darkside.\n\r" );
    return;
  }
  ...
  if( is_kaio( vch ) || is_android( vch ) || is_superandroid( vch ) )
  {
    if( IS_NPC( ch ) )
  ...
  act( AT_GREY, "it worked", ch, NULL, vch, TO_CHAR );
  vch->canmajin = TRUE;
...
/* if ( is_saiyanranked(rch) || is_saiyanranked(vch) )
 {
   ch_printf(ch,"One of them are ranked. Please remove it before fusion.\n\r");
   return;
 }*/
  ...
  if( is_android( rch ) || is_superandroid( rch ) || is_icer( rch ) || is_bio( rch ) || is_kaio( rch ) || is_demon( rch ) )
  {
    ch_printf( ch, "%s's race cannot fuse this way.\n\r", rch->name );
    return;
  }
  if( is_android( vch ) || is_superandroid( vch ) || is_icer( vch ) || is_bio( vch ) || is_kaio( vch ) || is_demon( vch ) )
  {
    ch_printf( ch, "%s's race cannot fuse this way.\n\r", vch->name );
    return;
  }
  ...
  if( is_saiyan_s( dch ) )
    dch->pcdata->learned[gsn_super_oozaru] = 0;
...
void do_summon( CHAR_DATA * ch, char *argument )
{
  ...
  if( !str_cmp( argument, "shenron" ) )
  {
     ...
     * *
     * * Karma? hmmmm... nope... let's check for Karn instead
     * *                -Karn 01.15.05
     * *
     * * Added Bruno and Viper. 05.31.05
     */
    if( ( victim = get_char_room( ch, "Kratos" ) ) == NULL && ( victim = get_char_room( ch, "test" ) ) == NULL
        && ( victim = get_char_room( ch, "bruno" ) ) == NULL )
    {
      ch_printf( ch, "\n\r&RYou cannot summon the dragon without Karn, Kratos, Test, or Bruno here.\n\r" );
      return;
    }
...
void do_showrank( CHAR_DATA * ch, char *argument )
{
  ...
  if( arg[0] == '\0' )
  {
    ch_printf( ch, "\n\rSyntax: showrank (kaio/demon/saiyan)\n\r" );
    return;
  }
  if( !str_cmp( arg, "kaio" ) )
  {
    ...
    ch_printf( ch, "&z====================================================\n\r" );
    ch_printf( ch, "&RSupreme Kai: &w%-17s", kaioshin[5] );
    if( get_char_name( kaioshin[5] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( kaioshin[5], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - kaioshinlast[5] ) / 3600 ) );
    ch_printf( ch, "&W  Grand Kai: &w%-17s", kaioshin[4] );
    if( get_char_name( kaioshin[4] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( kaioshin[4], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - kaioshinlast[4] ) / 3600 ) );
    ch_printf( ch, "&Y  North Kai: &w%-17s", kaioshin[3] );
    if( get_char_name( kaioshin[3] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( kaioshin[3], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - kaioshinlast[3] ) / 3600 ) );
    ch_printf( ch, "&B   West Kai: &w%-17s", kaioshin[2] );
    if( get_char_name( kaioshin[2] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( kaioshin[2], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - kaioshinlast[2] ) / 3600 ) );
    ch_printf( ch, "&G   East Kai: &w%-17s", kaioshin[1] );
    if( get_char_name( kaioshin[1] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( kaioshin[1], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - kaioshinlast[1] ) / 3600 ) );
    ch_printf( ch, "&g  South Kai: &w%-17s", kaioshin[0] );
    if( get_char_name( kaioshin[0] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( kaioshin[0], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - kaioshinlast[0] ) / 3600 ) );
    ch_printf( ch, "&z====================================================\n\r" );
    return;
  }
  ...
  else if( !str_cmp( arg, "demon" ) )
  {
    ...
    ch_printf( ch, "&z====================================================\n\r" );
    ch_printf( ch, "&R   Demon King: &w%-15s", demonking );
    if( get_char_name( demonking ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( demonking, "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - demonkinglast ) / 3600 ) );
    ch_printf( ch, "&rDemon Warlord: &w%-15s", demonwarlord[0] );
    if( get_char_name( demonwarlord[0] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( demonwarlord[0], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - demonwarlordlast[0] ) / 3600 ) );
    ch_printf( ch, "&rDemon Warlord: &w%-15s", demonwarlord[1] );
    if( get_char_name( demonwarlord[1] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( demonwarlord[1], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - demonwarlordlast[1] ) / 3600 ) );
    ch_printf( ch, "&rDemon Warlord: &w%-15s", demonwarlord[2] );
    if( get_char_name( demonwarlord[2] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( demonwarlord[2], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - demonwarlordlast[2] ) / 3600 ) );
    ch_printf( ch, "&OGreater Demon: &w%-15s", greaterdemon[0] );
    if( get_char_name( greaterdemon[0] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( greaterdemon[0], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - greaterdemonlast[0] ) / 3600 ) );
    ch_printf( ch, "&OGreater Demon: &w%-15s", greaterdemon[1] );
    if( get_char_name( greaterdemon[1] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( greaterdemon[1], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - greaterdemonlast[1] ) / 3600 ) );
    ch_printf( ch, "&OGreater Demon: &w%-15s", greaterdemon[2] );
    if( get_char_name( greaterdemon[2] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( greaterdemon[2], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - greaterdemonlast[2] ) / 3600 ) );
    ch_printf( ch, "&OGreater Demon: &w%-15s", greaterdemon[3] );
    if( get_char_name( greaterdemon[3] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( greaterdemon[3], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - greaterdemonlast[3] ) / 3600 ) );
    ch_printf( ch, "&OGreater Demon: &w%-15s", greaterdemon[4] );
    if( get_char_name( greaterdemon[4] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( greaterdemon[4], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - greaterdemonlast[4] ) / 3600 ) );
    ch_printf( ch, "&OGreater Demon: &w%-15s", greaterdemon[5] );
    if( get_char_name( greaterdemon[5] ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( greaterdemon[5], "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - greaterdemonlast[5] ) / 3600 ) );
    ch_printf( ch, "&z====================================================\n\r" );
    return;
  }

  else if( !str_cmp( arg, "saiyan" ) )
  {
    for( a = 0; a < 4; a++ )
    {
      if( saiyanelitelast[a] <= 0 )
      {
    ...
    ch_printf( ch, "\n\r" );
    ch_printf( ch, "&cSaiyan ranks and who currently holds them:\n\r" );
    ch_printf( ch, "&z====================================================\n\r" );
    ch_printf( ch, "&R      Saiyan King: &w%-11s", saiyanking );
    if( get_char_name( saiyanking ) )
      ch_printf( ch, "&w(online)\n\r" );
    else if( !str_cmp( saiyanking, "none" ) )
      ch_printf( ch, "\n\r" );
    else
      ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - saiyankinglast ) / 3600 ) );

    for( a = 0; a < 2; a++ )
    {
      ch_printf( ch, "&rSaiyan Prince(ss): &w%-11s", saiyanprince[a] );
      if( get_char_name( saiyanprince[a] ) )
        ch_printf( ch, "&w(online)\n\r" );
      else if( !str_cmp( saiyanprince[a], "none" ) )
        ch_printf( ch, "\n\r" );
      else
        ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - saiyanprincelast[a] ) / 3600 ) );
    }
    for( a = 0; a < 4; a++ )
    {
      ch_printf( ch, "&O     Saiyan Elite: &w%-11s", saiyanelite[a] );
      if( get_char_name( saiyanelite[a] ) )
        ch_printf( ch, "&w(online)\n\r" );
      else if( !str_cmp( saiyanelite[a], "none" ) )
        ch_printf( ch, "\n\r" );
      else
        ch_printf( ch, "&w(last on %2d hours ago)\n\r", ( ( current_time - saiyanelitelast[a] ) / 3600 ) );
    }
    ch_printf( ch, "&z====================================================\n\r" );
    return;
  }
...
void do_claimrank( CHAR_DATA * ch, char *argument )
{
  char arg[MAX_INPUT_LENGTH];
  char buf[MAX_STRING_LENGTH];
  if( !is_kaio( ch ) && !is_demon( ch ) && !is_saiyan( ch ) )
  {
    ch_printf( ch, "&wCommand available only to demons, kaios and saiyans.\n\r" );
    return;
  }
  if( is_fused( ch ) )
  {
    ch_printf( ch, "&wCommand not avalible to fusions.\n\r" );
    return;
  }
  /*
   * if ( !is_saiyanranked(ch) && !str_cmp(saiyanking,"None") || !is_saiyanranked(ch) && !str_cmp(saiyanprince[a],"None") || !is_saiyanranked(ch) && !str_cmp(saiyanelite[a],"None"))
   * {
   * send_to_char("&RRank is already filled.D\n\r",ch);
   * return;
   * }
   */
  argument = one_argument( argument, arg );
  ...
  if( arg[0] == '\0' )
  {
    ch_printf( ch, "&wSyntax: claimrank (rank)\n\r" );
    ch_printf( ch, "\n\rRank being one of:\n\r" );
    if( is_kaio( ch ) )
    {
      ch_printf( ch, "  Southkai Eastkai Westkai Northkai Grandkai Supremekai\n\r" );
      ch_printf( ch, "\n\rSk, ek, wk, and nk all require a base pl of 1bil to claim via this command.\n\r" );
      ch_printf( ch, "Gk requires 10bil, and Spk requires 100bil.\n\r" );
    }
    if( is_demon( ch ) )
    {
      ch_printf( ch, "  Greaterdemon Demonwarlord Demonking\n\r" );
      ch_printf( ch, "\n\rGreater requires 1bil pl, Warlord requires 10bil, and King required 100bil.\n\r" );
    }
    if( is_saiyan( ch ) )
    {
      ch_printf( ch, "  Saiyanelite Saiyanprince Saiyanking\n\r" );
      ch_printf( ch, "\n\rElite requires 1bil pl, Prince requires 10bil, and King required 100bil.\n\r" );
    }
    return;
  }
  if( is_kaio( ch ) )
...
/*	if( ch->rank > 0 )
	{
	  ch_printf(ch,"You already have a rank.\n\r");
	  return;
	} */
    if( !str_cmp( arg, "southkai" ) )
    {
      if( kaioshin[0] && str_cmp( kaioshin[0], "None" ) )
      {
        ch_printf( ch, "That rank is already taken.\n\r" );
        return;
      }
      if( ch->exp < 1000000000 )
      {
        ch_printf( ch, "You need a powerlevel of at least 1,000,000,000 to claim this rank.\n\r" );
        return;
      }
      if( ch->rank > 1 )
      {
        send_to_char( "You can't lower your rank like that.\n\r", ch );
        return;
      }
      STRFREE( kaioshin[0] );
      kaioshin[0] = STRALLOC( ch->name );
      ch->rank = 1;
      save_sysdata( sysdata );
      save_char_obj( ch );
      sprintf( buf, "&R%s has claimed the vacant South Kaioshin rank.", ch->name );
      echo_to_all( AT_RED, buf, ECHOTAR_ALL );
      return;
    }
    if( !str_cmp( arg, "eastkai" ) )
    {
      if( kaioshin[1] && str_cmp( kaioshin[1], "None" ) )
      {
        ch_printf( ch, "That rank is already taken.\n\r" );
        return;
      }
      ...
      STRFREE( kaioshin[1] );
      kaioshin[1] = STRALLOC( ch->name );
      ch->rank = 2;
      save_sysdata( sysdata );
      save_char_obj( ch );
      sprintf( buf, "&R%s has claimed the vacant East Kaioshin rank.", ch->name );
      echo_to_all( AT_RED, buf, ECHOTAR_ALL );
      return;
    }
    if( !str_cmp( arg, "westkai" ) )
    {
      if( kaioshin[2] && str_cmp( kaioshin[2], "None" ) )
      {
        ch_printf( ch, "That rank is already taken.\n\r" );
        return;
      }
      ...
      STRFREE( kaioshin[2] );
      kaioshin[2] = STRALLOC( ch->name );
      ch->rank = 3;
      save_sysdata( sysdata );
      save_char_obj( ch );
      sprintf( buf, "&R%s has claimed the vacant West Kaioshin rank.", ch->name );
      echo_to_all( AT_RED, buf, ECHOTAR_ALL );
      return;
    }
    if( !str_cmp( arg, "northkai" ) )
    {
      if( kaioshin[3] && str_cmp( kaioshin[3], "None" ) )
      {
        ch_printf( ch, "That rank is already taken.\n\r" );
        return;
      }
      ...
      STRFREE( kaioshin[3] );
      kaioshin[3] = STRALLOC( ch->name );
      ch->rank = 4;
      save_sysdata( sysdata );
      save_char_obj( ch );
      sprintf( buf, "&R%s has claimed the vacant North Kaioshin rank.", ch->name );
      echo_to_all( AT_RED, buf, ECHOTAR_ALL );
      return;
    }
    if( !str_cmp( arg, "grandkai" ) )
    {
      if( kaioshin[4] && str_cmp( kaioshin[4], "None" ) )
      {
        ch_printf( ch, "That rank is already taken.\n\r" );
        return;
      }
      if( ch->exp < 10000000000ULL )
      {
        ch_printf( ch, "You need a powerlevel of at least 10,000,000,000 to claim this rank.\n\r" );
        return;
      }
      if( ch->rank > 5 )
      {
      ...
      STRFREE( kaioshin[4] );
      kaioshin[4] = STRALLOC( ch->name );
      ch->rank = 5;
      save_sysdata( sysdata );
      save_char_obj( ch );
      sprintf( buf, "&R%s has claimed the vacant Grand Kaioshin rank.", ch->name );
      echo_to_all( AT_RED, buf, ECHOTAR_ALL );
      return;
    }
    if( !str_cmp( arg, "supremekai" ) )
    {
      int a = 0;

      if( kaioshin[5] && str_cmp( kaioshin[5], "None" ) )
      {
        ch_printf( ch, "That rank is already taken.\n\r" );
        return;
      }
      ...
      {
        ch_printf( ch, "You need a powerlevel of at least 100,000,000,000 to claim this rank.\n\r" );
        return;
      }
      ...
      STRFREE( kaioshin[5] );
      kaioshin[5] = STRALLOC( ch->name );
      ch->rank = 6;
      save_sysdata( sysdata );
      save_char_obj( ch );
      sprintf( buf, "&R%s has claimed the vacant Supreme Kaioshin rank.", ch->name );
      echo_to_all( AT_RED, buf, ECHOTAR_ALL );
      return;
    }
  }
...
/*	if( ch->rank > 0 )
    ...
    if( !str_cmp( arg, "demonking" ) )
    {
      if( demonking && str_cmp( demonking, "None" ) )
      {
        ch_printf( ch, "That rank is already taken.\n\r" );
        return;
      }
      ...
      for( b = 0; b < 6; b++ )
      {
        if( !str_cmp( greaterdemon[b], ch->name ) )
        {
          STRFREE( greaterdemon[b] );
          greaterdemon[b] = STRALLOC( "none" );
          greaterdemonlast[b] = current_time;
          save_sysdata( sysdata );
          save_char_obj( ch );
        }
      }
      for( b = 0; b < 3; b++ )
      {
        if( !str_cmp( demonwarlord[b], ch->name ) )
        {
          STRFREE( demonwarlord[b] );
          demonwarlord[b] = STRALLOC( "none" );
          demonwarlordlast[b] = current_time;
          save_sysdata( sysdata );
          save_char_obj( ch );
        }
      }
      ...
      save_sysdata( sysdata );
      save_char_obj( ch );
      sprintf( buf, "&R%s has claimed the vacant Demon King rank.", ch->name );
      echo_to_all( AT_RED, buf, ECHOTAR_ALL );
      return;
    }
    if( !str_cmp( arg, "demonwarlord" ) )
    {
      int a = 0;
      if( ch->exp < 10000000000ULL )
      {
      ...
      if( ch->rank >= 2 )
      {
        send_to_char( "You can't change your rank like that.\n\r", ch );
        return;

      }
      for( a = 0; a < 3; a++ )
      {
        if( demonwarlord[a] && str_cmp( demonwarlord[a], "None" ) )
          continue;
        ...
        demonwarlord[a] = STRALLOC( ch->name );
        ch->rank = 2;
        save_sysdata( sysdata );
        save_char_obj( ch );
        sprintf( buf, "&R%s has claimed a vacant Demon Warlord rank.", ch->name );
        echo_to_all( AT_RED, buf, ECHOTAR_ALL );
        return;
      }
      ch_printf( ch, "&wThat rank is already taken.\n\r" );
      return;
    }
    if( !str_cmp( arg, "greaterdemon" ) )
    {
      if( ch->exp < 1000000000 )
      {
        ch_printf( ch, "You need a powerlevel of at least 1,000,000,000 to claim this rank.\n\r" );
      ...
      for( a = 0; a < 6; a++ )
      {
        if( greaterdemon[a] && str_cmp( greaterdemon[a], "None" ) )
          continue;
        STRFREE( greaterdemon[a] );
        greaterdemon[a] = STRALLOC( ch->name );
        ch->rank = 1;
        save_sysdata( sysdata );
        save_char_obj( ch );
        sprintf( buf, "&R%s has claimed a vacant Greater Demon rank.", ch->name );
        echo_to_all( AT_RED, buf, ECHOTAR_ALL );
        return;
      }
      ch_printf( ch, "&wThat rank is already taken.\n\r" );
  ...
  if( is_saiyan( ch ) )
  {
    ...
    if( !str_cmp( arg, "saiyanking" ) )
    {
      if( saiyanking && str_cmp( saiyanking, "None" ) )
      {
        ch_printf( ch, "That rank is already taken.\n\r" );
        return;
      }
      ...
      for( b = 0; b < 4; b++ )
      {
        if( !str_cmp( saiyanelite[b], ch->name ) )
        {
          STRFREE( saiyanelite[b] );
          saiyanelite[b] = STRALLOC( "none" );
          saiyanelitelast[b] = current_time;
          break;
        }
      }
      for( b = 0; b < 2; b++ )
      {
        if( !str_cmp( saiyanprince[b], ch->name ) )
        {
          STRFREE( saiyanprince[b] );
          saiyanprince[b] = STRALLOC( "none" );
          saiyanprincelast[b] = current_time;
          break;
        }
      }

      STRFREE( saiyanking );
      saiyanking = STRALLOC( ch->name );
      ch->rank = 3;
      ch->pcdata->learned[gsn_lssj] = 100;
      SET_BIT( ch->pcdata->flags, PCFLAG_KNOWSLSSJ );
      save_sysdata( sysdata );
      save_char_obj( ch );
      sprintf( buf, "&R%s has claimed the vacant Saiyan King rank.", ch->name );
      echo_to_all( AT_RED, buf, ECHOTAR_ALL );
      return;
    }
    if( !str_cmp( arg, "saiyanprince" ) )
    {
      int a = 0;
      if( ch->exp < 10000000000ULL )
      {
      ...
      for( a = 0; a < 2; a++ )
      {
        if( saiyanprince[a] && str_cmp( saiyanprince[a], "None" ) )
          continue;
        ...
        saiyanprince[a] = STRALLOC( ch->name );
        ch->rank = 2;
        save_sysdata( sysdata );
        save_char_obj( ch );
        sprintf( buf, "&R%s has claimed a vacant Saiyan Prince rank.", ch->name );
        echo_to_all( AT_RED, buf, ECHOTAR_ALL );
        return;
      }
      ch_printf( ch, "&wThat rank is already taken.\n\r" );
    ...
    if( !str_cmp( arg, "saiyanelite" ) )
    {
      ...
      for( a = 0; a < 4; a++ )
      {
        if( saiyanelite[a] && str_cmp( saiyanelite[a], "None" ) )
          continue;
        STRFREE( saiyanelite[a] );
        saiyanelite[a] = STRALLOC( ch->name );
        ch->rank = 1;
        save_sysdata( sysdata );
        save_char_obj( ch );
        sprintf( buf, "&R%s has claimed a vacant Elite Saiyan rank.", ch->name );
        echo_to_all( AT_RED, buf, ECHOTAR_ALL );
        return;
      }
      ch_printf( ch, "&wThat rank is already taken.\n\r" );
...
//if ( !IS_IMMORTAL(ch) ) {send_to_char("pfft. no. :)\n\r", ch); return;}
  ...
  if( arg < 2 || arg > 28 )
  {
    send_to_char( "Syntax: ultra [2-28]\n\r", ch );
    return;
  }
...
void do_hssj( CHAR_DATA * ch, char *argument )
{
  ...
  {
    ch_printf( ch, "Syntax: hssj [10-16]\n\r" );
    return;
  }
  ...
  if( arg < 10 || arg > 16 )
  {
    send_to_char( "Syntax: hssj [10-16]\n\r", ch );
    return;
  }
...
void do_essj( CHAR_DATA * ch, char *argument )
{
  ...
  {
    ch_printf( ch, "Syntax: essj [24-30]\n\r" );
    return;
  }
  ...
  if( arg < 24 || arg > 30 )
  {
    send_to_char( "Syntax: essj [24-30]\n\r", ch );
    return;
  }
  ...
  if( can_use_skill( ch, number_percent(  ), gsn_essj ) )
  {
    ...
    ch->pl = ch->exp * pl_mult;
    if( pl_mult == 24 )
      transStatApply( ch, 24, 12, 6, 19 );
    if( pl_mult == 25 )
      transStatApply( ch, 25, 12, 6, 20 );
    if( pl_mult == 26 )
      transStatApply( ch, 26, 13, 7, 21 );
    if( pl_mult == 27 )
      transStatApply( ch, 27, 13, 7, 22 );
    if( pl_mult == 28 )
      transStatApply( ch, 28, 14, 8, 23 );
    if( pl_mult == 29 )
      transStatApply( ch, 29, 14, 8, 24 );
    if( pl_mult == 30 )
      transStatApply( ch, 30, 15, 9, 25 );
    else
      transStatApply( ch, pl_mult, pl_mult, pl_mult, pl_mult );
    if( xIS_SET( ( ch )->affected_by, AFF_MAJIN ) )
      ch->pl = ch->pl * 1.1;
...
void do_finalshine( CHAR_DATA * ch, char *argument )
{
  ...
  if( !is_saiyan_s( ch ) )
  {
    send_to_char( "Your not a Saiyan-s, why are you using this?", ch );
    return;
  }
  ...
  {
    act( AT_BLUE, "You missed $N with your Final Burst.", ch, NULL, victim, TO_CHAR );
    act( AT_BLUE, "$n misses you with $s Final Burst.", ch, NULL, victim, TO_VICT );
    act( AT_BLUE, "$n missed $N with a Final Burst.", ch, NULL, victim, TO_NOTVICT );
...
void do_clawstrike( CHAR_DATA * ch, char *argument )
{
  ...
  if( can_use_skill( ch, number_percent(  ), gsn_clawstrike ) )
  {
    ...
    if( ch->charge > 0 )
      dam = chargeDamMult( ch, dam );
    act( AT_DGREY, "You extend your claws and slash at $N.", ch, NULL, victim, TO_CHAR );
    act( AT_DGREY, "$N is struck by claws" "You pull your hand back. &W[$t]", ch, num_punct( dam ), victim, TO_CHAR );
    act( AT_DGREY, "$n's claw comes straight towards you.", ch, NULL, victim, TO_VICT );
    act( AT_DGREY, "$n slices you with its claws, then pulls them back. &W[$t]", ch, num_punct( dam ), victim, TO_VICT );
    act( AT_DGREY, "$n's claw strike slice into $N.", ch, NULL, victim, TO_NOTVICT );
    act( AT_DGREY, "$N is cut by the claw, "
         "which haste $n's quickly pulls the claw back. &W[$t]", ch, num_punct( dam ), victim, TO_NOTVICT );
...
void do_daichiretsuzan(CHAR_DATA *ch, char *argument )
{
    ...
    if ( !IS_NPC(ch)
    &&   ch->exp < skill_table[gsn_daichiretsuzan]->skill_level[ch->class] )
    {
	send_to_char( "You can't do that.\n\r", ch );
	return;
    }
...
void do_honoo(CHAR_DATA *ch, char *argument )
{
    ...
    if ( !IS_NPC(ch)
    &&   ch->exp < skill_table[gsn_honoo]->skill_level[ch->class] )
    {
	send_to_char( "You can't do that.\n\r", ch );
	return;
    }
	...
	if (ch->charge > 0)
		dam = chargeDamMult(ch, dam);
	      act( AT_RED, "Confident of your capabilities, you turn your back towards $N with a", ch, NULL, victim, TO_CHAR );
            ...
            act( AT_RED, "attack, you quickly pivot around to face $M and stretch your mouth extensively.", ch, NULL, victim, TO_CHAR ); 
            act( AT_RED, "Without delay a prodigious amount of fire streams from your jaws in an unfocused", ch, NULL, victim, TO_CHAR ); 
            act( AT_RED, "pattern to scorch the entire surroundings. The blazing inferno that once erupted", ch, NULL, victim, TO_CHAR ); 
            act( AT_RED, "from your mouth quickly subsides and leaves $N critically wounded.", ch, num_punct( dam ), victim, TO_CHAR );
                        ...
                        act( AT_RED, "extensively. Without delay a prodigious amount of fire streams from $s jaws in an", ch, NULL, victim, TO_VICT ); 
                        act( AT_RED, "unfocused pattern to scorch the entire surroundings. The blazing inferno that once", ch, NULL, victim, TO_VICT ); 
                        act( AT_RED, "erupted from $s mouth quickly subsides and leaves you critically wounded.", ch, num_punct( dam ), victim, TO_VICT );
                        ...
                        act( AT_RED, "Concentrating only long enough to hone in on the precise spot $e wishes to", ch, NULL, victim, TO_NOTVICT ); 
                        act( AT_RED, "attack, $n quickly pivots around to face $N and stretches $s mouth", ch, NULL, victim, TO_NOTVICT ); 
                        act( AT_RED, "extensively. Without delay a prodigious amount of fire streams from $s jaws in an", ch, NULL, victim, TO_NOTVICT ); 
                        act( AT_RED, "unfocused pattern to scorch the entire surroundings. The blazing inferno that once", ch, NULL, victim, TO_NOTVICT ); 
                        act( AT_RED, "erupted from $s mouth quickly subsides and leaves $N critically wounded.", ch, num_punct( dam ), victim, TO_NOTVICT );
...
void do_buuball(CHAR_DATA *ch, char *argument )
{
    ...
    if ( !IS_NPC(ch)
    &&   ch->exp < skill_table[gsn_buuball]->skill_level[ch->class] )
    {
	send_to_char( "You can't do that.\n\r", ch );
	return;
    }
	...
	act( AT_PURPLE, "You fly up into the air and mold yourself into a ball and dash at $N.", ch, NULL, victim, TO_CHAR );
            act( AT_PURPLE, "You hit them up into the air and comeback with a few more hits till $N falls", ch, NULL, victim, TO_CHAR );
            act( AT_PURPLE, "to their demise.", ch, num_punct( dam ), victim, TO_CHAR ); 
            
            act( AT_PURPLE, "$N flies up into the air and molds themself into a ball and dashes at you.", ch, NULL, victim, TO_VICT );
            act( AT_PURPLE, "$N hits you up into the air and comes backs with a few more hits till you fall", ch, NULL, victim, TO_VICT );
            act( AT_PURPLE, "to your demise.", ch, num_punct( dam ), victim, TO_VICT );


            act( AT_PURPLE, "$N flies up into the air and molds themself into a ball and dashes at $S.", ch, NULL, victim, TO_NOTVICT );
            act( AT_PURPLE, "$N hits them up into the air and comes back with a few more hits till $S falls", ch, NULL, victim, TO_NOTVICT );
